...
export class Configuration {
  ...
  addMachineConfig(machineName: string, {path: machinePath, context}: {path: string, context?: MachineContext}, autoSave = true): MachineConfig {
