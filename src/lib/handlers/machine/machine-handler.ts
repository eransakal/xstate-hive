...
import {createMachinePrompts} from '../../transformers/create-machine/prompts.js'
import {formatMachineName, toDashCase} from '../../utils/formatters.js'
import {createMachineTransformer} from '../../transformers/create-machine/index.js'
...
import {CreateMachineOptions, validateCreateMachineOptions} from '../../transformers/create-machine/types.js'
